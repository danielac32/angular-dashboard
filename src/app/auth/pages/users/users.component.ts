...
constructor(private route: ActivatedRoute,private router: Router,private authService: AuthService/*,private dataService: DataService*/) {}
  ...
  editar(id?:string){
      if (id !== undefined) {
         this.router.navigate(['/dashboard/users/edit'],{ queryParams: { parametro: id } });
      }
  }

  eliminar(id?:string){
      if (id !== undefined) {
         this.router.navigate(['/dashboard/users/edit'],{ queryParams: { parametro: id ,parametro2:"delete"} });
      }
  }
